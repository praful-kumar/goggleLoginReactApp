...
function Home() {
    return (
        <div className='homeMain'>
            ...
            <div className='info'>
                    <h5>Get the latest on our COVID-19 response</h5>
                </div>
                <div className='imgCover'>
                    ...
                    <div className='user'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M3 4h18v2H3V4zm0 7h18v2H3v-2zm0 7h18v2H3v-2z" fill="rgba(96,96,96,1)"/></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M4 22a8 8 0 1 1 16 0H4zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6z" fill="rgba(94,90,90,1)"/></svg>
                    </div>
                    ...
                    <h5 className='textbox'>Explore nearby stays</h5>
                </div>
